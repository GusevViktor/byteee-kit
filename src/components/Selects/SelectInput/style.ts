...
export const Wrap = styled.div<SelectInputProps>`
  position: relative;
`
...
`
export const Select = styled.button<SelectInputProps>`
  position: relative;
  box-sizing: border-box;
  width: 100%;
  display: flex;
...
export const Wrapper = styled.div<SelectInputProps>`
position: relative;
box-sizing: border-box;
width: 100%;
display: flex;
...
cursor: pointer;
`
export const Input = styled.input<SelectInputProps>`
position: relative;
box-sizing: border-box;
width: 100%;
display: flex;
